...
int main(int argc, char *argv[]) {
    ...
    while(iterations--) {
        ...
        m_drt = drt4_moments(image);
        t0 = ((double)getTickCount()-t0)/getTickFrequency();

        t1 = (double)getTickCount();
        m_ocv = opencv4_moments(image);
    ...
    cout << "[" << log10(m_drt.m40) << "] m40 [" << log10(m_ocv.m40) << "]" << endl;
    cout << "[" << log10(m_drt.m04) << "] m04 [" << log10(m_ocv.m04) << "]" << endl;
    cout << "[" << log10(m_drt.m31) << "] m31 [" << log10(m_ocv.m31) << "]" << endl;
    cout << "[" << log10(m_drt.m13) << "] m13 [" << log10(m_ocv.m13) << "]" << endl;
    cout << "[" << log10(m_drt.m22) << "] m22 [" << log10(m_ocv.m22) << "]" << endl;
